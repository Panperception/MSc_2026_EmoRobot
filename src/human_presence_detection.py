...
class HumanPresenceDetection:
    ...
    def __init__(self, kinematic_interface=None, detection_framerate=None, external_vad_trigger=False, emotion_analyzer=None):
                ...
                for face_obj in face_objs:                         
                    ...
                    try:
                        ...
                        if self.emotion_analyzer:
                            self.emotion_analyzer.analyze_face(roi)
